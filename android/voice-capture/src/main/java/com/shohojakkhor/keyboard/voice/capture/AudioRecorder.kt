 ...
 *   - A recording auto-finishes at [ShohojakkhorAudio.MAX_DURATION_MS] even if the
...
class AudioRecorder(
    ...
    private val maxDurationMs: Long = ShohojakkhorAudio.MAX_DURATION_MS,
    ...
    fun start() {
        ...
        thread = Thread({ runCapture() }, "shohojakkhor-audio-recorder").apply {
            isDaemon = true
            start()
        }
    }
